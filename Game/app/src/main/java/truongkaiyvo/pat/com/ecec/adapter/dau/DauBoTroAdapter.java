...
public class DauBoTroAdapter extends BaseAdapter {
    List<TuiDoBoTro> tuiDoBoTros = new ArrayList<>();

    public DauBoTroAdapter(List<TuiDoBoTro> tuiDoBoTros) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.item_the_bo_tro_dau,parent,false);
