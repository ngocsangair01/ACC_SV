package truongkaiyvo.pat.com.ecec.adapter.chontuong;
...
public class ChonTuongAdapter extends BaseAdapter {
    List<TuiDoTuong> tuiDoTuongs = new ArrayList<>();

    public ChonTuongAdapter(List<TuiDoTuong> tuiDoTuongs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Sup.daChonTuongs.add(tuiDoTuong);
